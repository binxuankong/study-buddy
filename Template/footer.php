    <div class="learn-more">
      <div class="container">
        <div class="row">
          <div class="col-md-3">
             <h2><img src="/M3StudyBuddy/Images/new_logo.png" alt="Studdy Buddy"></img>Study Buddy</h2>
          </div>
          <div class="col-md-3">
            <h3>About Us</h3>
            <p>The team behind this website is the M3 Group of the School of Computer Science from the University of Manchester.</p>
            <p><a href="/M3StudyBuddy/Pages/AboutUs.php">Learn more about each members of the team</a></p>
          </div>
          <div class="col-md-3">
            <h3>Get Started</h3>
            ...
            <p><a href="/M3StudyBuddy/Pages/GetStarted.php">Get going with Study Buddy</a></p>
          </div>
          <div class="col-md-3">
            <h3>Feedback</h3>
            ...
            <p><a href="/M3StudyBuddy/Pages/Feedback.php">Send a feedback</a></p>
          </div>
        </div>
      </div>
    </div>
